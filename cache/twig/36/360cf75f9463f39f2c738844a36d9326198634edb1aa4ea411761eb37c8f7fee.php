...
class __TwigTemplate_d85209077e4f54f20d697705bc20c989d086812b4c228974e908227da968cf17 extends Twig_Template
{
...
<table>
    ";
        ...
        foreach ($context['_seq'] as $context["slug"] => $context["plugin"]) {
            ...
            // line 20
            echo "        ";
            $context["releaseDate"] = (($this->getAttribute($context["plugin"], "date", array())) ? ($this->getAttribute($context["plugin"], "date", array())) : ($this->getAttribute($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "gpm", array()), "findPackage", array(0 => $context["slug"]), "method"), "date", array())));
            // line 21
            echo "
        <tr data-gpm-plugin=\"";
            // line 22
...
", "partials/plugins-list.html.twig", "/Users/matt/git/alexs-website/user/plugins/admin/themes/grav/templates/partials/plugins-list.html.twig");
    }
}
