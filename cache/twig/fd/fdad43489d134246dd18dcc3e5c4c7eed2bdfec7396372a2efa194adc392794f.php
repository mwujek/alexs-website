...
class __TwigTemplate_cb91c9a835ae7bc72f77ffe1ad3fd2eebd92cf71cdcb7f27d0a30c2fcf5483a4 extends Twig_Template
{
...
<div class=\"themes card-row grid fixed-blocks pure-g\">
    ";
        ...
        foreach ($context['_seq'] as $context["slug"] => $context["theme"]) {
            ...
            // line 21
            echo "        ";
            $context["releaseDate"] = (($this->getAttribute($context["theme"], "date", array())) ? ($this->getAttribute($context["theme"], "date", array())) : ($this->getAttribute($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "gpm", array()), "findPackage", array(0 => $context["slug"]), "method"), "date", array())));
            // line 22
            echo "
...
", "partials/themes-list.html.twig", "/Users/matt/git/alexs-website/user/plugins/admin/themes/grav/templates/partials/themes-list.html.twig");
    }
}
